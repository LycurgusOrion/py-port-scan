...
class TestPortScanner(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.scan_1 = port_scanner.Scan(target="172.217.167.4",
                                        ports=[80],
                                        threads=100,
                                        timeout=3)
        self.scan_2 = port_scanner.Scan(target="172.217.167.4",
                                        ports=[1],
                                        threads=100,
                                        timeout=3)

        self.mulScan_1 = port_scanner.MultiScan(targets=["172.217.167.4"],
                                                ports=[80],
                                                threads=100,
                                                timeout=3)
        self.mulScan_2 = port_scanner.MultiScan(targets=["172.217.167.4"],
                                                ports=[1],
                                                threads=100,
                                                timeout=3)
    ...
    def test_run_full_scan(self):
        ...
        self.assertEqual(self.mulScan_1.log[self.mulScan_1.targets[0]]
                                           ["Number of Closed Ports"], 0)
        self.assertEqual(self.mulScan_1.log[self.mulScan_1.targets[0]]
                                           ["Closed Ports"], [])
        self.assertEqual(self.mulScan_1.log[self.mulScan_1.targets[0]]
        ...
        self.assertGreater(self.mulScan_1.log[self.mulScan_1.targets[0]]
                                             ["Runtime"], 0)

        self.assertEqual(self.mulScan_2.log[self.mulScan_2.targets[0]]
                                           ["Number of Closed Ports"], 1)
        self.assertEqual(self.mulScan_2.log[self.mulScan_2.targets[0]]
                                           ["Closed Ports"], [1])
        self.assertEqual(self.mulScan_2.log[self.mulScan_2.targets[0]]
        ...
        self.assertGreater(self.mulScan_2.log[self.mulScan_2.targets[0]]
                                             ["Runtime"], 0)
